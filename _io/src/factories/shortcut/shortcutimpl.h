...
class ShortcutImpl {
    public:
        ...
        virtual bool createStartShorcut(AppPath _appPath, QString _shortcutName, QString _applicationName) = 0;
        virtual bool createStartMenuShorcut(AppPath _appPath, QString _startMenuFolderName, QString _applicationName) = 0;
};
