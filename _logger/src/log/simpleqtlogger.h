...
const QString DEFAULT_LOG_FORMAT          = "[<TS>] <LL> -  <TEXT> (<FUNC>@<FILE>:<LINE>)";
const QString DEFAULT_LOG_FORMAT_INTERNAL = "[<TS>] <LL> -  <TEXT>"; // sink file-log: following TAGs are not processed: <FUNC>, <FILE>, <LINE>
...
static const QString LOG_LEVEL_CHAR[8] = {"FATAL", "ERROR", "WARN ", "NOTE ", "INFO ", "DEBUG", "FUNCT", "INTER"}; // MUST correspond to enum LogLevel, unchecked array!!!
